...
public class MizanController {
	...
	public Map<String, Object> sorgula(@RequestBody mizanDTO mizanDTO) {
		...
		try {
			...
			response.put("data", (mizan != null) ? mizan : new ArrayList<>());
	...
	public ResponseEntity<byte[]> downloadReport(@RequestBody mizanDTO mizanDTO) {
		...
		try {
			...
			String fileName = "Cari_Mizan." + mizanDTO.getFormat().toLowerCase();
