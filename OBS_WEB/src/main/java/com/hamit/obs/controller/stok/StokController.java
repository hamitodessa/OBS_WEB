...
public class StokController {
	...
	public Map<String, String> getBaslik() {
		String[] detay  = faturaService.conn_detail();
		Map<String, String> response = new HashMap<>();
		try {
			response.put("baslik", faturaService.fat_firma_adi() + " / " + detay[1]);
	...
	@PostMapping("stok/anaoz1")
	@ResponseBody
	public Map<String, Object>  anaoz1() {
		Map<String, Object> response = new HashMap<>();
		try {
			List<Map<String, Object>> anaKodlari = faturaService.stk_kod_degisken_oku("ANA_GRUP", "AGID_Y", "ANA_GRUP_DEGISKEN") ;
			Map<String, Object> anaDeger = new HashMap<>();
			...
			response.put("ozKodlari", (oz1Kodlari != null) ? oz1Kodlari : new ArrayList<>());
			response.put("errorMessage","");
		} catch (ServiceException e) {
