...
public class GirisController {
	...
	@PostMapping("kereste/giris_download")
	public ResponseEntity<byte[]> giris_download(@RequestBody keresteyazdirDTO keresteyazdirDTO) {
		ByteArrayDataSource dataSource ;
		try {
			dataSource =  raporOlustur.kereste_giris(keresteyazdirDTO);
			if (dataSource == null) {
			...
			String fileName = "Kereste_Giris.xlsx";
